...
public class AddToCartController extends HttpServlet {
    ...
    private static final String SUCCESS2 = "SearchCategoryController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = quantityPurchased <= quantity ? true : false;
            if (check) {
                ...
                if (cart == null) {
                    ...
                    boolean checkCart = (cartQuantity + quantityPurchased) <= inventory ? true : false;
                    if (checkCart) {
                        cart.add(product);
                        session.setAttribute("CART", cart);
                        String messageSuccess = "Add To Cart Successfully!!";
